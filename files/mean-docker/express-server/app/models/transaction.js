...
transaction.statics = {
    findTsByName: async function(userId)  {
        var result1 = await this.find({mainAccountName: userName}).exec();
        var result2 = await this.find({secondAccountName: userName}).exec();
